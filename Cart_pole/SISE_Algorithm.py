...
def SISE_algorithm(NN,h,enumerate_poly,D,all_hyperplanes,all_bias,W_h,c_h,W_x,c_x,TH,border_hype,border_bias,zeros,eps1,eps2,alpha,parallel,NN_file,iter,bound):
    ...
    while state:
        ...
        _,_,_,_,points_all,region_all=updating_BF_LV(NN,h,enumerate_poly,D,all_hyperplanes,all_bias,W_h,c_h,border_hype,border_bias)
        points=np.zeros((0,n))
        _,_,b_reg,label=finding_all_info(index,V,points,all_hyperplanes,all_bias,W_h,D,c_h,TH)
