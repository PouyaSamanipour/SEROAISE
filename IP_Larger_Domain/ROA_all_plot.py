...
from plot_res_Lyap import plot_polytope_2D,plot_polytope,plot_invariant_set_single,plot_heatmap,plot_level_set
from Dai_data_set import dai_data_Set
...
saved_state = torch.load("NN_files/pendulum_state_to_save_lyap.pt", map_location=lambda storage, loc: storage)
...
h="NN_files/model_IP_Dai_linear_BF_updated.pt"
# plt.rcParams.update({'font.size': 10})
zeros1=np.array([[-1.20000000e+01, -1.11169380e-02],
 [-6.65545080e+00,  1.20000000e+01],
 [ 6.62541448e+00, -1.20000000e+01],
 [ 1.20000000e+01, -6.90888480e-02]])
# zeros1=[]
...
# plt.colorbar(c1)
Levels=dai_data_Set()
plt.plot(Levels[:,0],Levels[:,1],'orange')
# train_diameter = 3.0
# rect = patches.Rectangle((-train_diameter, -train_diameter), train_diameter * 2, train_diameter * 2, linewidth=2, edgecolor='r', facecolor='none')
...
plt.tight_layout()
plt.savefig(os.getcwd()+'/Figures/'+"Comparing_Results.png")
